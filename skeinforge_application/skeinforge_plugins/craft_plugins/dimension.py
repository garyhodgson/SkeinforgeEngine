...
#		((self.restartDistance * self.retractionRatio) - (self.restartDistance * self.retractionRatio)* self.autoRetractDistance)
		self.extruderRetractionSpeedMinuteString = self.gcode.getRounded(60.0 * self.repository.extruderRetractionSpeed.value)
...
#		self.newFlowrate = str (round(self.flowRate * self.flowScaleSixty,0) )
		...
		#self.gcode.addLine('M108 S' + newFlowrate)
		self.gcode.addLine(line)
