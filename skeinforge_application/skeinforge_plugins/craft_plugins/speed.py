	...
	def parseInitialization(self):
		...
		for self.lineIndex in xrange(len(self.lines)):
			...
			if firstWord == '(<layerThickness>':
				...
				self.gcode.addTagBracketedLine('operatingFeedRatePerSecond', self.feedRatePerSecond )
				self.gcode.addTagBracketedLine('PerimeterFeedRatePerSecond', self.repository.perimeterFeedRateOverOperatingFeedRate )
				if self.repository.addFlowRate.value:
					self.gcode.addTagBracketedLine('operatingFlowRate', self.repository.flowRateSetting.value * self.repository.feedRatePerSecond.value )
					self.gcode.addTagBracketedLine('PerimeterFlowRate', self.repository.perimeterFlowRateOverOperatingFlowRate.value * self.repository.perimeterFeedRateOverOperatingFeedRate.value )
				...
				self.gcode.addTagBracketedLine('travelFeedRatePerSecond', self.repository.travelFeedRatePerSecond.value )
